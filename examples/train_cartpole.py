...
def generate_train_test_cartpole(n_exp=100,model_parameters=[1.5,0.5], t_i=0.0, t_end=10.0, n_steps=100, destination_folder="./", name_file="cartpole",seed = 0,extension="csv",delimiter=",", data_size=8000, batch_size=125,device = "cpu", normalize = True):
